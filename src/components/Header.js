...
class Header extends Component {
    ...
    axios.get(`${API_URL}/getAllUsers`).then(result=>{
    ...
    googleLogin = (e) => {
    const {email,familyName,givenName}=e.profileObj;
    const req1 = {
        username: email,
        password: 'nopassword'
    }
                ...
                <Modal isOpen={isLoginModalOpen} style={customStyles}>
                    ...
                    <form className="mt-4">
                        ...
                        <div className="mt-4">
                            ...
                            /> 
                            <GoogleLogin 
                                clientId="942909839570-r3jumoogrseh1ua8b5qtftpognmobcg6.apps.googleusercontent.com"
